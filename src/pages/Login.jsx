  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: 'radial-gradient(circle, rgba(99,56,240,0.35) 0%, transparent 70%)',
        borderRadius: '50%',
      ...
      <div style={{
        ...
        `}</style>
        <div className="slide-up" style={{ textAlign: 'center', color: 'white', zIndex: 1 }}>
          <div style={{
          ...
          <h1 style={{ fontSize: '2.8rem', fontWeight: '800', lineHeight: '1.15', marginBottom: '20px', letterSpacing: '-0.03em' }}>
            Kelola Tugas<br />
            <span style={{
          ...
          <p style={{ fontSize: '1.05rem', color: 'rgba(255,255,255,0.65)', lineHeight: '1.7', maxWidth: '340px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '10px', justifyContent: 'center', flexWrap: 'wrap', marginTop: '36px' }}>
            {['Kalender Pintar', 'Notifikasi Real-time', 'Analitik Nilai'].map((f, i) => (
              <span key={i} style={{
      ...
      <div className="login-form-panel" style={{
        ...
        {/* Logo + Title */}
        <div className="slide-up" style={{ marginBottom: '36px', display: 'flex', alignItems: 'center', gap: '16px' }}>
          <div style={{
          ...
          <div>
            <h1 style={{ fontSize: '1.9rem', fontWeight: '800', marginBottom: '4px', letterSpacing: '-0.02em', color: 'var(--text-main)', lineHeight: 1.1 }}>
              <span style={{ fontSize: '2.6rem', fontWeight: '900', background: 'var(--primary-gradient)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
                {t('welcome').charAt(0)}
              </span>
              {t('welcome').slice(1)}
            </h1>
        ...
        <form onSubmit={handleLogin} className="slide-up-1">
          ...
          >
            {isLoading ? (
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" style={{ animation: 'spin-slow 0.8s linear infinite' }}>
        ...
        {/* Divider */}
        <div className="slide-up-2" style={{ display: 'flex', alignItems: 'center', gap: '12px', margin: '24px 0' }}>
          <div style={{ flex: 1, height: '1px', background: 'var(--border)' }} />
          <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)', fontWeight: '700', letterSpacing: '0.06em' }}>ATAU</span>
          <div style={{ flex: 1, height: '1px', background: 'var(--border)' }} />
        </div>
        ...
        <button
          ...
          style={{
            ...
            cursor: 'pointer', fontFamily: 'inherit', fontSize: '0.93rem', fontWeight: '700',
            color: 'var(--text-main)', transition: 'all 0.2s ease',
          }}
          onMouseEnter={e => { e.currentTarget.style.background = 'var(--surface)'; e.currentTarget.style.borderColor = 'var(--primary)'; e.currentTarget.style.transform = 'translateY(-1px)'; }}
        ...
        <div className="slide-up-4" style={{ textAlign: 'center', marginTop: '28px', fontSize: '0.88rem' }}>
